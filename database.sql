...
-- Demo reports
-- ----------------------------------------------------------------
INSERT INTO reports (report_code, citizen_id, disaster_type, title, description, affected_people, status, severity, severity_score, latitude, longitude, location_name, created_at) VALUES
...
('RPT-007', 1, 'নদীভাঙন',   'ময়মনসিংহে নদীভাঙন — বসতবাড়ি ক্ষতিগ্রস্ত',
 ...
 350,  'verified',    'medium',    40, 24.747100, 90.420300, 'ময়মনসিংহ নদী তীর',       '2026-08-28 09:30:00'),
...
('RPT-008', 5, 'জলাবদ্ধতা', 'ঢাকার নিচু এলাকায় দীর্ঘস্থায়ী জলাবদ্ধতা',
 ...
 1800, 'pending',     'unassessed', NULL, 23.710400, 90.407400, 'পুরান ঢাকা',             '2026-08-27 15:00:00'),
...
('RPT-009', 1, 'বন্যা',      'কুমিল্লায় হঠাৎ বন্যা — ফসল নষ্ট',
 ...
 780,  'pending',     'low',       22, 23.460700, 91.180900, 'কুমিল্লা সদর',            '2026-08-26 12:00:00'),
...
('RPT-010', 4, 'ঘূর্ণিঝড়', 'যশোরে ঘূর্ণিঝড়ের প্রভাবে ক্ষয়ক্ষতি',
 ...
 620,  'rejected',    'low',       18, 23.166700, 89.216700, 'যশোর সদর',                '2026-08-25 08:00:00');
